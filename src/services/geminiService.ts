...
const SHEET_CATEGORY_MAP: Record<string, Category> = {
  ...
  'maghreb': Category.MAGHREB,
  'vie quotidienne': Category.MAGHREB,
  'quotidien': Category.MAGHREB,
  'maghreb & vie quotidienne': Category.MAGHREB,
  'maghreb & quotidien': Category.MAGHREB,
  'futur': Category.TECH,
  'tech': Category.TECH,
  'ia': Category.TECH,
