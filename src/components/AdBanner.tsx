    ...
    <div className="space-y-12 py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="border-2 border-zinc-200 rounded-3xl p-8 shadow-lg">
          ...
          <a href="https://vrax-voyage.com" target="_blank" rel="noopener noreferrer" className="block w-full bg-blue-600 text-white font-black py-4 rounded-2xl text-center hover:bg-blue-700 transition-all">
        ...
        <div className="border-2 border-zinc-200 rounded-3xl p-8 shadow-lg">
          ...
          <a href="https://limamvirtuel.com" target="_blank" rel="noopener noreferrer" className="block w-full bg-green-600 text-white font-black py-4 rounded-2xl text-center hover:bg-green-700 transition-all">
        ...
        <div className="border-2 border-zinc-200 rounded-3xl p-8 shadow-lg">
          ...
          <a href="https://bachiratmani1313.systeme.io/30245d2f" target="_blank" rel="noopener noreferrer" className="block w-full bg-red-600 text-white font-black py-4 rounded-2xl text-center hover:bg-red-700 transition-all">
      ...
      <div className="bg-zinc-900 text-white rounded-3xl p-16 text-center space-y-6">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center pt-4">
          <a href="https://bachiratmani1313.systeme.io/30245d2f" target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-white text-red-600 font-black rounded-full hover:scale-105 transition-all">
            Découvrir Le Compagnon 2030
          </a>
          <a href="https://limamvirtuel.com" target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-white/20 border-2 border-white text-white font-black rounded-full hover:scale-105 transition-all">
